...
export function Sponsors() {
  ...
  return (
    <section id="sponsors" className="py-24 md:py-32 bg-deep relative overflow-hidden" ref={ref}>
      {/* Background */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
            Powered <span className="text-teal">By</span>
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-teal to-cyber mx-auto rounded-full mb-6" />
          <p className="text-lg text-hudson max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-20">
          {sponsors.map((sponsor, index) => (
            <motion.div
              ...
              className="group glow-card rounded-2xl bg-monarch/30 backdrop-blur-sm border border-teal/10 p-6 md:p-8 flex flex-col items-center text-center"
            >
              ...
              {sponsor.subtitle && <p className="text-silver text-xs md:text-sm">{sponsor.subtitle}</p>}
            </motion.div>
          ))}
        </div>
        ...
        <motion.div
          ...
          id="contact"
          className="glow-card rounded-2xl bg-gradient-to-br from-monarch/50 to-deep/50 backdrop-blur-sm border border-teal/20 p-8 md:p-12 text-center"
        >
          <h3 className="font-display text-2xl md:text-3xl font-bold text-white mb-4">Become a Sponsor</h3>
          <p className="text-hudson max-w-xl mx-auto mb-8">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="inline-flex items-center gap-3 bg-teal hover:bg-[#00d4ff] text-deep px-8 py-4 rounded-lg font-bold transition-all shadow-lg shadow-teal/25"
          >
