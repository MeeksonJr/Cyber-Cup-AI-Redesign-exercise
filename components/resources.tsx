      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-hudson/20 border border-monarch/20 mb-4">
            <BookOpen className="w-5 h-5 text-monarch" />
            <span className="text-sm font-semibold text-monarch uppercase tracking-wider">Resources</span>
          </div>
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-monarch mb-4">
            Learning <span className="text-teal">Resources</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {resources.map((resource, categoryIndex) => (
            <motion.div
              ...
              className="bg-white rounded-[0.625rem] border border-silver/20 p-6 hover:shadow-lg transition-all"
            >
              {/* Category Header */}
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-lg bg-hudson/20 flex items-center justify-center">
                  <resource.icon className="w-6 h-6 text-monarch" />
                </div>
                <h3 className="font-display text-xl font-bold text-monarch">{resource.category}</h3>
              </div>
              ...
              <div className="space-y-4">
                {resource.items.map((item, itemIndex) => (
                  <motion.a
                    ...
                    className="block p-4 rounded-lg border border-silver/10 hover:border-teal/40 hover:bg-[#f0f4f8] transition-all group"
                  >
                    <div className="flex items-start justify-between gap-3 mb-2">
                      <h4 className="font-semibold text-monarch group-hover:text-teal transition-colors">
                        {item.title}
                      </h4>
                      <div className="flex items-center gap-2 text-silver group-hover:text-teal transition-colors">
        ...
        >
          <p className="text-silver mb-6">Looking for more resources?</p>
